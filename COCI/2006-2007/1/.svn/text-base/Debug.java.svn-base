...
public class Debug
{
	...
	static class Fila
	{
		...
		public Fila(String e)
		{
			esta = e;
			bID = new int[e.length()];
			bDI = new int[e.length()];
		}
	}
	public static void main(String[] args)
	{
		...
		for(Fila f : entrada)
		{
			...
			for(int i = 0; i < f.esta.length(); i++)
				f.bID[i] = posicionActual + i;
